...
This directory contains samples for Google Cloud Datastore. `Cloud Datastore`_ is a NoSQL document database built for automatic scaling, high performance, and ease of application development.
