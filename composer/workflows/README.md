...
[![image](https://gstatic.com/cloudssh/images/open-btn.png)](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/GoogleCloudPlatform/python-docs-samples&page=editor&open_in_editor=composer/workflows/README.rst)

This directory contains samples for Google Cloud Composer. [Google Cloud
Composer](https://cloud.google.com/composer/docs) is a fully managed
