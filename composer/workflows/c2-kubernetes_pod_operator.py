...
#
# Licensed under the Apache License, Version 2.0 (the {{ quot_code }}License{{ quot_code }});
...
# distributed under the License is distributed on an {{ quot_code }}AS IS{{ quot_code }} BASIS,
