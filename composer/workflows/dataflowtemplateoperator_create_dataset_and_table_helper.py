...
# the location where you want your BigQuery data to reside.
# For more info on possible locations see https://cloud.google.com/bigquery/docs/locations
location = "US"

# if you are copying and pasting this code, be sure to uncomment this line as well:
