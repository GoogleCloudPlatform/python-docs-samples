...
# [START vertexai_sklearn_task]
# [START vertexai_sklearn_task_imports]
import argparse
import os
import re
...
# [END vertexai_sklearn_task_imports]


# [START vertexai_sklearn_task_args]
...
# [END vertexai_sklearn_task_args]


# [START vertexai_sklearn_task_fit]
def fit_model(
    input_path: str,
    model_dir: str,
    degree: int = 1,
...
# [END vertexai_sklearn_task_fit]

# [START vertexai_sklearn_task_export]
    # Save model to GCS
    print("Saving model")
    ...
    print("Model saved")
# [END vertexai_sklearn_task_export]
