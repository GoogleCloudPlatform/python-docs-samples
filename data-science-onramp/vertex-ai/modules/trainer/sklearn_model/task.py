...
# [START vertex_ai_sklearn_task]
# [START vertex_ai_sklearn_task_imports]
import argparse
import os
import re
...
# [END vertex_ai_sklearn_task_imports]


# [START vertex_ai_sklearn_task_args]
...
# [END vertex_ai_sklearn_task_args]


# [START vertex_ai_sklearn_task_fit]
def fit_model(
    input_path: str,
    model_dir: str,
    degree: int = 1,
...
# [END vertex_ai_sklearn_task_fit]

# [START vertex_ai_sklearn_task_export]
    # Save model to GCS
    print("Saving model")
    ...
    print("Model saved")
# [END vertex_ai_sklearn_task_export]
