...
import pytest
from snippets.iam_create_service_account import create_service_account
...
def test_create_service_account(
    capsys: "pytest.CaptureFixture[str]", service_account: str
) -> None:
    # Test service account is created.
