...
ca_cert_path = '../receive/resources/roots.pem'
rsa_cert_path = '../receive/resources/rsa_cert.pem'
rsa_private_path = '../receive/resources/rsa_private.pem'
...
def test_send(test_topic, capsys):
