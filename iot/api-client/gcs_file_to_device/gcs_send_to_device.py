...
def make_file_public(bucket_name, gcs_file_name):
    ...
    print('File {} is publicly accessible at {}'.format(
        config.name, config.public_url))
...
def parse_command_line_args():
    ...
    parser.add_argument(
        '--gcs_file_name',
        required=True,
        help='The name of the file to be sent.')
    parser.add_argument(
        '--source_file_name',
        required=True,
    ...
    parser.add_argument(
        '--registry_id',
        required=True,
        help='The registry for the device.')
    parser.add_argument(
        '--device_id',
        required=True,
...
def main():
    ...
    print('Checking if bucket {} exists and creating it if doesn\'t...'
