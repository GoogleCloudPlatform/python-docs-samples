...
def test_create_delete_registry(test_topic, capsys):
    ...
    manager.list_devices(service_account_json, project_id, cloud_region, registry_id)
...
def test_list_gateways(test_topic, capsys):
    ...
    manager.list_gateways(service_account_json, project_id, cloud_region, registry_id)
