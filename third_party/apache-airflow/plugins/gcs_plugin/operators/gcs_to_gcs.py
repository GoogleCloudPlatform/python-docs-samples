...
class GoogleCloudStorageToGoogleCloudStorageOperator(BaseOperator):
    ...
    **Examples**:
        ...
        named ``copied_sales/2017/january-backup.avro` in the
        ``data_backup`` bucket ::
    ...
    Notes:
    1. Place this module inside plugins/gcs_plugin/operators
    2. The GCS hook must be downloaded from the Airflow repository
