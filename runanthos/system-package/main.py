...
# [START runanthos_system_package_handler]
...
# [END runanthos_system_package_handler]


# [START runanthos_system_package_exec]
def create_diagram(dot):
    ...
    dot_args = [  # These args add a watermark to the dot graphic.
        "-Glabel=Made on Cloud Run for Anthos",
        "-Gfontsize=10",
        "-Glabeljust=right",
        "-Glabelloc=bottom",
        "-Gfontcolor=gray",
...
# [END runanthos_system_package_exec]
