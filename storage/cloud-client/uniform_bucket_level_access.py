...
if __name__ == '__main__':
    ...
    enable_uniform_bucket_level_access_parser = subparsers.add_parser(
        'enable-uniform-bucket-level-access', help=enable_uniform_bucket_level_access.__doc__)
    ...
    disable_uniform_bucket_level_access_parser = subparsers.add_parser(
        'disable-uniform-bucket-level-access', help=disable_uniform_bucket_level_access.__doc__)
