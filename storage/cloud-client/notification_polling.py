...
class GcsEvent(object):
  ...
  def dup_string(self):
    ...
    # topic, and Cloud Pub/Sub will deliver each message to each subscription
    # at least once. We must be able to safely handle occasionally receiving
    # duplicate messages.
