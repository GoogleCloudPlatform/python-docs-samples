...
Google Cloud Bigtable instance creation
===============================================================================
...
.. image:: https://gstatic.com/cloudssh/images/open-btn.png
   :target: https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/GoogleCloudPlatform/python-docs-samples&page=editor&open_in_editor=bigtable/quickstart.py,bigtable/quickstart/README.rst
...
.. code-block:: bash
    ...
    .. Prerequisites:
    	...
    	Need to replace project_id, instance_id, table_id and row_id 'r1' in the code as per user created values.
