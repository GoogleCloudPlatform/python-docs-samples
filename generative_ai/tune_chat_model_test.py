...
def teardown_model(
    tuned_model: ChatModel, training_data_filename: str
) -> None:
...
def test_tuning_chat_model(training_data_filename: str) -> None:
    """Takes approx. 20 minutes."""
    tuned_model = tune_chat_model.tune_chat_model(
