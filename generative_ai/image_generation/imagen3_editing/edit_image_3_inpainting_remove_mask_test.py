...
import edit_image_3_inpainting_remove_mask
...
def test_edit_image_3_inpainting_remove_mask() -> None:
    response = edit_image_3_inpainting_remove_mask.edit_image_3_inpainting_remove_mask(
        _INPUT_FILE,
        _MASK_FILE,
        _OUTPUT_FILE,
        _PROMPT,
