...
def edit_image_3_product_image(
    input_file: str,
    output_file: str,
    prompt: str,
) -> vision_models.ImageGenerationResponse:
    # [START generativeaionvertexai_imagen_edit_image_3_product_image]
    ...
    mask_ref_image = MaskReferenceImage(
        reference_id=1, image=None, mask_mode="background"
    )
    ...
    # [END generativeaionvertexai_imagen_edit_image_3_product_image]

    return images


if __name__ == "__main__":
    edit_image_3_product_image(
