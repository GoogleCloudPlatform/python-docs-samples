...
def edit_image_3_inpainting_remove_mask_mode(
    input_file: str,
    mask_mode: str,
    output_file: str,
    prompt: str,
) -> vision_models.ImageGenerationResponse:
    # [START generativeaionvertexai_imagen_edit_image_3_inpainting_remove_mask_mode]
    ...
    mask_ref_image = MaskReferenceImage(
        reference_id=1, image=None, mask_mode=mask_mode, dilation=0.01
    )
    ...
    # [END generativeaionvertexai_imagen_edit_image_3_inpainting_remove_mask_mode]

    return images


if __name__ == "__main__":
    edit_image_3_inpainting_remove_mask_mode(
        input_file="../test_resources/woman.png",
        mask_mode="foreground",
        output_file="../test_resources/background.png",
        prompt="",
    )
