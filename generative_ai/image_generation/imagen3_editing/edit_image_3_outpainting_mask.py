...
def edit_image_3_outpainting_mask(
    input_file: str,
    mask_file: str,
    output_file: str,
    prompt: str,
) -> vision_models.ImageGenerationResponse:
    # [START generativeaionvertexai_imagen_edit_image_3_outpainting_mask]
    ...
    # [END generativeaionvertexai_imagen_edit_image_3_outpainting_mask]
