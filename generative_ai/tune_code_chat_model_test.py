...
def teardown_model(
    tuned_model: CodeChatModel, training_data_filename: str
) -> None:
...
def test_tuning_code_chat_model(training_data_filename: str) -> None:
    """Takes approx. 20 minutes."""
    tuned_model = tune_code_chat_model.tune_code_chat_model(
