...
def list_deployable_models(list_hugging_face_models_only : bool = False, model_filter : str = "") -> List[str]:
    # [START aiplatform_modelgarden_list_deployable_models]
    ...
    deployable_models = model_garden.list_deployable_models(list_hf_models=list_hugging_face_models_only, model_filter=model_filter)
    print(deployable_models)
    # Example response:
    # ['google/gemma2@gemma-2-27b','google/gemma2@gemma-2-27b-it', ...]

    # [END aiplatform_modelgarden_list_deployable_models]
