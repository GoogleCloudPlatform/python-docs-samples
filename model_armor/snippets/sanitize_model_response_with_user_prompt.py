...
"""
Sample code for sanitizing a model response using model armor along with
user prompt.
"""
...
def sanitize_model_response_with_user_prompt(
    project_id: str,
    location_id: str,
    template_id: str,
    model_response: str,
    ...
    Args:
        ...
        user_prompt (str): The user prompt to pass with model response.
