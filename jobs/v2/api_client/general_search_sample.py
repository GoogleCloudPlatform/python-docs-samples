...
def compensation_search(client_service, company_name):
    ...
    compensation_range = {
        "max": {"currency_code": "USD", "units": 15},
        "min": {"currency_code": "USD", "units": 10, "nanos": 500000000},
    }
    compensation_filter = {
...
def run_sample():
    ...
    compensation_info = {
        "entries": [{"type": "BASE", "unit": "HOURLY", "amount": amount}]
    }
    ...
    employment_types_search(
        client_service, company_name, ["FULL_TIME", "CONTRACTOR", "PER_DIEM"]
    )
