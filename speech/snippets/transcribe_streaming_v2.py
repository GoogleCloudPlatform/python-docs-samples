...
def transcribe_streaming_v2(
    ...
    Returns:
        list[cloud_speech_types.StreamingRecognizeResponse]: A list of `StreamingRecognizeResponse` objects
        from the API. Each response includes the transcription results for the corresponding audio segment.
    """
...
if __name__ == "__main__":
    ...
    transcribe_streaming_v2(path_to_audio_file)
