...
r"""Google Cloud Speech API sample that demonstrates how to request word level confidence information.
...
def speech_transcribe_word_level_confidence(speech_file):
...
def speech_transcribe_word_level_confidence_gcs(gcs_uri):
