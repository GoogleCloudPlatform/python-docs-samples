...
"""Google Cloud Speech-to-Text streaming sample demonstrating Beta features

This sample builds upon the `transcribe_streaming_mic.py` sample in the
same directory.
...
def main():
    ...
    # Provide a list of languages that may be included
    # in the streaming audio
    alternative_language_codes = ['fr-FR', 'de-DE']
