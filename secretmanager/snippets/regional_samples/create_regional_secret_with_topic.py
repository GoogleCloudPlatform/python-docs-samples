...
def create_regional_secret_with_topic(
    ...
    """
    Creates a new regional secret with a Pub/Sub topic configured for notifications.
    ...
    Example:
        # Create a regional secret with a Pub/Sub topic
        create_regional_secret_with_topic(
            "my-project",
            "my-secret-with-topic",
            "us-central1",
