...
from access_regional_secret_version import access_regional_secret_version
from add_regional_secret_version import add_regional_secret_version
from create_regional_secret import create_regional_secret
from delete_regional_secret import delete_regional_secret
from delete_regional_secret_with_etag import delete_regional_secret_with_etag
from destroy_regional_secret_version import destroy_regional_secret_version
from destroy_regional_secret_version_with_etag import destroy_regional_secret_version_with_etag
from disable_regional_secret_version import disable_regional_secret_version
from disable_regional_secret_version_with_etag import disable_regional_secret_version_with_etag
from enable_regional_secret_version import enable_regional_secret_version
from enable_regional_secret_version_with_etag import enable_regional_secret_version_with_etag
from get_regional_secret import get_regional_secret
from get_regional_secret_version import get_regional_secret_version
from iam_grant_access_with_regional_secret import iam_grant_access_with_regional_secret
from iam_revoke_access_with_regional_secret import iam_revoke_access_with_regional_secret
from list_regional_secret_versions import list_regional_secret_versions
from list_regional_secret_versions_with_filter import list_regional_secret_versions_with_filter
from list_regional_secrets import list_regional_secrets
from list_regional_secrets_with_filter import list_regional_secrets_with_filter
...
def retry_client_add_regional_secret_version(
    regional_client: secretmanager_v1.SecretManagerServiceClient,
    request: Optional[Union[secretmanager_v1.AddSecretVersionRequest, dict]],
) -> secretmanager_v1.SecretVersion:
    # Retry to avoid 503 error & flaky issues
    return regional_client.add_secret_version(request=request)
