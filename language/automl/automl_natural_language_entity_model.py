...
def create_model(project_id, compute_region, dataset_id, model_name):
    """Create a entity extraction model."""
...
def get_model_evaluation(
    ...
    print("Entity model evaluated example count: {}".format(response.evaluated_example_count))
    print("Entity model evaludation metrics: {}".format(response.text_extraction_evaluation_metrics))
