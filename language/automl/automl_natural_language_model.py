...
def create_model(
        project_id, compute_region, dataset_id, model_name):
    """Create a model.
    Args:
        project_id: Id of the project.
        compute_region: Region name.
        dataset_id: Id of the dataset to which model is created.
