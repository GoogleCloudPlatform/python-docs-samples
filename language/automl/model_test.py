...
def test_model_list_get_evaluate(capsys):
    # list models
    automl_natural_language_model.list_models(project_id, compute_region, '')
    out, _ = capsys.readouterr()
    ...
    automl_natural_language_model.list_model_evaluations(project_id, compute_region, 
        model_id, '')
    out, _ = capsys.readouterr()
    ...
    automl_natural_language_model.get_model_evaluation(project_id, compute_region, 
