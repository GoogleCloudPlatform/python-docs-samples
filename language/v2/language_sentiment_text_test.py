...
def test_sample_analyze_sentiment_text(capsys: ...) -> None:
    ...
    assert (
        ...
        and "Document sentiment magnitude: 0." in captured.out
        and "Sentence text: I am so happy and joyful." in captured.out
        and "Sentence sentiment score: 0." in captured.out
        and "Sentence sentiment magnitude: 0." in captured.out
