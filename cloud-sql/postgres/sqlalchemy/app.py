...
from connect_connector_iam_authn import connect_with_connector_iam_authn
...
def init_connection_pool() -> sqlalchemy.engine.base.Engine:
    ...
    if os.environ.get("INSTANCE_CONNECTION_NAME"):
        ...
        return connect_with_connector_iam_authn() if os.environ.get("DB_IAM_USER") else connect_with_connector()
