...
def add_data_types():
    ...
    data = {
        ...
        u"nullExample": None,
        u"objectExample": {u"a": 5, u"b": True},
    }
...
class City(object):
    ...
    def __repr__(self):
        return u"City(name={}, country={}, population={}, capital={}, regions={})".format(
            self.name, self.country, self.population, self.capital, self.regions
        )
...
def add_example_data():
    ...
    cities_ref.document(u"SF").set(
        City(
            u"San Francisco", u"CA", u"USA", False, 860000, [u"west_coast", u"norcal"]
        ).to_dict()
    )
    cities_ref.document(u"LA").set(
        City(
            u"Los Angeles", u"CA", u"USA", False, 3900000, [u"west_coast", u"socal"]
        ).to_dict()
    )
    cities_ref.document(u"DC").set(
        City(u"Washington D.C.", None, u"USA", True, 680000, [u"east_coast"]).to_dict()
    )
    cities_ref.document(u"TOK").set(
        City(u"Tokyo", None, u"Japan", True, 9000000, [u"kanto", u"honshu"]).to_dict()
    )
...
def update_multiple():
    ...
    doc_ref.update({u"name": u"Washington D.C.", u"country": u"USA", u"capital": True})
    # [END update_multiple]
...
def update_create_if_missing():
    ...
    city_ref.set({u"capital": True}, merge=True)
...
def update_nested():
    ...
    frank_ref.set(
        {
            u"name": u"Frank",
            u"favorites": {u"food": u"Pizza", u"color": u"Blue", u"subject": u"Recess"},
            u"age": 12,
        }
    )

    # Update age and favorite color
    frank_ref.update({u"age": 13, u"favorites.color": u"Red"})
    # [END update_nested]
...
def update_server_timestamp():
    ...
    city_ref.update({u"timestamp": firestore.SERVER_TIMESTAMP})
...
def update_data_transaction():
    ...
    def update_in_transaction(transaction, city_ref):
        ...
        transaction.update(city_ref, {u"population": snapshot.get(u"population") + 1})
...
def compound_query_valid_multi_clause():
    ...
    sydney_query = cities_ref.where(u"state", u"==", u"CO").where(
        u"name", u"==", u"Denver"
    )
    large_us_cities_query = cities_ref.where(u"state", u"==", u"CA").where(
...
def compound_query_invalid_multi_field():
    ...
    cities_ref = db.collection(u"cities")
    cities_ref.where(u"state", u">=", u"CA").where(u"population", u">=", 1000000)
...
def order_simple_limit_desc():
    ...
    cities_ref = db.collection(u"cities")
    query = cities_ref.order_by(u"name", direction=firestore.Query.DESCENDING).limit(3)
...
def order_where_limit():
    ...
    cities_ref = db.collection(u"cities")
    query = (
        cities_ref.where(u"population", u">", 2500000).order_by(u"population").limit(2)
    )
    results = query.stream()
...
def order_where_valid():
    ...
    cities_ref = db.collection(u"cities")
    query = cities_ref.where(u"population", u">", 2500000).order_by(u"population")
    results = query.stream()
...
def cursor_simple_end_at():
    ...
    cities_ref = db.collection(u"cities")
    query_end_at = cities_ref.order_by(u"population").end_at({u"population": 1000000})
...
def snapshot_cursors():
    ...
    start_at_snapshot = (
        db.collection(u"cities").order_by(u"population").start_at(snapshot)
    )
...
def cursor_paginate():
    ...
    next_query = (
        cities_ref.order_by(u"population")
        .start_after({u"population": last_pop})
        .limit(3)
    )
...
def cursor_multiple_conditions():
    ...
    start_at_name_and_state = (
        ...
        .order_by(u"name")
        .order_by(u"state")
        .start_at({u"name": u"Springfield", u"state": u"Missouri"})
    )
...
def delete_field():
    ...
    # [START delete_field]
    city_ref = db.collection(u"cities").document(u"BJ")
    city_ref.update({u"capital": firestore.DELETE_FIELD})
    # [END delete_field]
...
def collection_group_query(db):
    ...
    sf_landmarks.document().set({u"name": u"Golden Gate Bridge", u"type": u"bridge"})
    sf_landmarks.document().set({u"name": u"Legion of Honor", u"type": u"museum"})
    la_landmarks = cities.document(u"LA").collection(u"landmarks")
    la_landmarks.document().set({u"name": u"Griffith Park", u"type": u"park"})
    la_landmarks.document().set({u"name": u"The Getty", u"type": u"museum"})
    dc_landmarks = cities.document(u"DC").collection(u"landmarks")
    dc_landmarks.document().set({u"name": u"Lincoln Memorial", u"type": u"memorial"})
    dc_landmarks.document().set(
        {u"name": u"National Air and Space Museum", u"type": u"museum"}
    )
    tok_landmarks = cities.document(u"TOK").collection(u"landmarks")
    tok_landmarks.document().set({u"name": u"Ueno Park", u"type": u"park"})
    tok_landmarks.document().set(
        {u"name": u"National Museum of Nature and Science", u"type": u"museum"}
    )
    bj_landmarks = cities.document(u"BJ").collection(u"landmarks")
    bj_landmarks.document().set({u"name": u"Jingshan Park", u"type": u"park"})
    bj_landmarks.document().set(
        {u"name": u"Beijing Ancient Observatory", u"type": u"museum"}
    )
...
def in_query_with_array(db):
    ...
    query = cities_ref.where(u"regions", u"in", [[u"west_coast"], [u"east_coast"]])
    return query
