...
def test_delete_endpoint(capsys: pytest.LogCaptureFixture) -> None:
...
def test_delete_service(capsys: pytest.LogCaptureFixture) -> None:
...
def test_delete_namespace(capsys: pytest.LogCaptureFixture) -> None:
