...
# [START list_documents_folder_sample]
import sys
...
def list_documents_folder(project_number: str, location: str, user_id: str) -> None:
    ...
    print(f"Folder Contents: {linked_targets_response}")
# [END list_documents_folder_sample]
