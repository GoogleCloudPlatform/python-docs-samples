...
def dicomweb_search_instance(
    service_account_json, base_url, project_id, cloud_region, dataset_id, dicom_store_id
):
...
def dicomweb_retrieve_study(
    ...
    with open(file_name, "wb") as f:
        ...
        print(
            "Retrieved study and saved to file "
...
def dicomweb_retrieve_instance(
    ...
    with open(file_name, "wb") as f:
        f.write(response.content)
        print(
            "Retrieved DICOM instance and saved to file "
            + "{} in current directory".format(file_name)
        )
...
def dicomweb_retrieve_rendered(
    ...
    with open(file_name, "wb") as f:
        f.write(response.content)
        print(
            "Retrieved rendered image and saved to file "
            + "{} in current directory".format(file_name)
        )
