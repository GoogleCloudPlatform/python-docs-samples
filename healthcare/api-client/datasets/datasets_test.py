...
def test_CRUD_dataset(capsys):
    datasets.create_dataset(service_account_json, project_id, cloud_region, dataset_id)

    datasets.get_dataset(service_account_json, project_id, cloud_region, dataset_id)
...
def test_deidentify_dataset(capsys):
    ...
    datasets.delete_dataset(
        service_account_json, project_id, cloud_region, destination_dataset_id
    )
