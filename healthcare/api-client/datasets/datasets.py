...
def get_dataset(service_account_json, project_id, cloud_region, dataset_id):
...
def patch_dataset(
    service_account_json, project_id, cloud_region, dataset_id, time_zone
):
...
def get_dataset_iam_policy(service_account_json, project_id, cloud_region, dataset_id):
...
def set_dataset_iam_policy(
    service_account_json, project_id, cloud_region, dataset_id, member, role, etag=None
):
...
def parse_command_line_args():
    ...
    parser.add_argument(
        "--keeplist_tags",
        default=None,
        help='The data to keeplist, for example "PatientID" ' 'or "StudyInstanceUID"',
    )
...
def run_command(args):
    ...
    if args.project_id is None:
        ...
        list_datasets(args.service_account_json, args.project_id, args.cloud_region)
