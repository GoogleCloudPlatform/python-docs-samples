...
# DO NOT EDIT! This is a generated sample ("Request",  "translate_list_language_names")
...
#   usage: python3 samples/v3beta1/translate_list_language_names.py [--language_code en] [--project_id "[Google Cloud Project ID]"]
