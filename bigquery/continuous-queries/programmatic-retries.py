...
def retry_bigquery_query(event, context):
    """Retries a failed BigQuery query.
    Args:
            ...
            data = {
                "configuration": {
                    "query": {
                        ...
                        "useLegacySql": False,
                        "continuous": True,
                        "connectionProperties":[{"key":"service_account","value":"bigquery-sa@nickorlove-demos.iam.gserviceaccount.com"}]
                        # ... other query parameters ...
                    },
                    "labels": {
                            "bqux_job_id_prefix": "continuous_query_label"
                        }
                },
                "jobReference": {
                        "projectId": project,
