...
def translation_handler(request: flask.Request) -> flask.Response:
  ...
  try:
    ...
    # Read the actual function calls
    calls = request_json["calls"]
    return translate_text([call[0] for call in calls], project, target)
...
def translate_text(calls: list[str], project: str, target: str):
  try:
    ...
    # Convert the translated value to the return array
    return_value = [
