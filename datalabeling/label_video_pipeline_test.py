...
@pytest.mark.slow
def test_label_video_pipeline(capsys):
    # Creates a dataset.
    ...
    import_data.import_data(
            dataset_resource_name, 'VIDEO',
            'gs://cloud-samples-data/datalabeling/video/video_dataset.csv')
    out, _ = capsys.readouterr()
    assert 'Dataset resource name:' in out

    # Starts the video data labeling.
    response = label_video.label_video(dataset_resource_name,
