...
if __name__ == "__main__":
    ...
    create_uptime_check_config_parser = subparsers.add_parser(
        "create-uptime-check", help=create_uptime_check_config.__doc__
    )
    create_uptime_check_config_parser.add_argument(
        "-d", "--display_name", required=False
    )
    create_uptime_check_config_parser.add_argument("-o", "--host_name", required=False)

    get_uptime_check_config_parser = subparsers.add_parser(
        "get-uptime-check-config", help=get_uptime_check_config.__doc__
    )
    get_uptime_check_config_parser.add_argument("-m", "--name", required=True)
    ...
    delete_uptime_check_config_parser.add_argument("-m", "--name", required=True)
    ...
    update_uptime_check_config_parser.add_argument("-m", "--name", required=True)
    ...
    if args.command == "list-uptime-check-configs":
        ...
        create_uptime_check_config(project_name(), args.host_name, args.display_name)
