...
"""Google Cloud Dialogflow API sample code using the BidiStreamingAnalyzeContent
API.
...
Example usage:
    ...
    python bidi_streaming_transcription.py
...
RESTART_TIMEOUT = 14 * 60  # seconds
HALF_CLOSE_TIMEOUT = 13 * 60  # seconds
