...
if __name__ == "__main__":
    ...
    list_parser = subparsers.add_parser("list", help=list_contexts.__doc__)
    list_parser.add_argument("--session-id", required=True)

    create_parser = subparsers.add_parser("create", help=create_context.__doc__)
    create_parser.add_argument("--session-id", required=True)
    create_parser.add_argument(
        "--context-id", help="The id of the context.", required=True
    )
    create_parser.add_argument(
        "--lifespan-count",
    ...
    delete_parser = subparsers.add_parser("delete", help=delete_context.__doc__)
    ...
    if args.command == "list":
        ...
        create_context(
            args.project_id, args.session_id, args.context_id, args.lifespan_count
        )
