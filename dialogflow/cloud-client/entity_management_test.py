...
def test_create_entity(capsys):
    ...
    entity_management.create_entity(PROJECT_ID, entity_type_id, ENTITY_VALUE_1, [])
...
def test_delete_entity(capsys):
    ...
    entity_management.delete_entity(PROJECT_ID, entity_type_id, ENTITY_VALUE_1)
    entity_management.delete_entity(PROJECT_ID, entity_type_id, ENTITY_VALUE_2)
