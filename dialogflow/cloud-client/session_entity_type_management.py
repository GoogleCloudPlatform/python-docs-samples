...
def list_session_entity_types(project_id, session_id):
    ...
    session_entity_types = session_entity_types_client.list_session_entity_types(
        session_path
    )
...
if __name__ == "__main__":
    ...
    list_parser = subparsers.add_parser("list", help=list_session_entity_types.__doc__)
    ...
    create_parser.add_argument(
        ...
        default=(
            dialogflow_v2.enums.SessionEntityType.EntityOverrideMode.ENTITY_OVERRIDE_MODE_OVERRIDE
        ),
    )
    ...
    if args.command == "list":
        ...
        create_session_entity_type(
            ...
            args.session_id,
            args.entity_values,
            args.entity_type_display_name,
            args.entity_override_mode,
        )
