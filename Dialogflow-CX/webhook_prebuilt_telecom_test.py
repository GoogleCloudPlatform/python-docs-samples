...
def test_invalid_phoneline(app):
    ...
    request = {"fulfillmentInfo": {"tag": "validatePhoneLine"},
               "pageInfo": {"formInfo": {"parameterInfo": [{"displayName": "phone_number", "value": '9999999999'}]}}}
...
def test_invalid_phoneline2(app):
    ...
    request = {"fulfillmentInfo": {"tag": "validatePhoneLine"},
               "pageInfo": {"formInfo": {"parameterInfo": [{"displayName": "phone_number", "value": '1231231234'}]}}}
...
def test_cruiseplan_notcovered(app):
    ...
    request = {"fulfillmentInfo": {"tag": "cruisePlanCoverage"},
               "pageInfo": {"formInfo": {"parameterInfo": [{"displayName": "destination", "value": 'china'}]}}}
...
def test_international_coverage1(app):
    ...
    request = {"fulfillmentInfo": {"tag": "internationalCoverage"},
               "pageInfo": {"formInfo": {"parameterInfo": [{"displayName": "destination", "value": 'singapore'}]}}}
...
def test_international_coverage2(app):
    ...
    request = {"fulfillmentInfo": {"tag": "internationalCoverage"},
               "pageInfo": {"formInfo": {"parameterInfo": [{"displayName": "destination", "value": 'russia'}]}}}
...
def test_cheapest_plan1(app):
    ...
    request = {"fulfillmentInfo": {"tag": "cheapestPlan"},
               "pageInfo": {"formInfo": {"parameterInfo": [{"displayName": "trip_duration", "value": 40}]}}}
...
def test_cheapest_plan2(app):
    ...
    request = {"fulfillmentInfo": {"tag": "cheapestPlan"},
               "pageInfo": {"formInfo": {"parameterInfo": [{"displayName": "trip_duration", "value": 20}]}}}
...
def test_cheapest_plan3(app):
    ...
    request = {"fulfillmentInfo": {"tag": "cheapestPlan"},
               "pageInfo": {"formInfo": {"parameterInfo": [{"displayName": "trip_duration", "value": 5}]}}}
