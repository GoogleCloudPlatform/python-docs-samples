...
def generate_test_challenge_files():
  ...
  # Sign challenges
  signed_challenges = ykman_utils.sign_challenges(challenge_list)
...
def create_challenges():
  public_key_files = list(
      pathlib.Path.cwd().glob("generated_public_keys/public_key*.pem")
  )
  challenges = []
...
def test_sign_and_verify_challenges():
  signed_challenges = ykman_utils.sign_challenges(create_challenges())
...
def test_sign_no_matching_public_keys_fail():
  modified_challenges = create_challenges()
