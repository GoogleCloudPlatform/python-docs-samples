#ifndef EXPERIMENTAL_USERS_BRANDONLUONG_CFMWRAP_HSM_FUNCTIONS_H_
#define EXPERIMENTAL_USERS_BRANDONLUONG_CFMWRAP_HSM_FUNCTIONS_H_
...
#endif  // EXPERIMENTAL_USERS_BRANDONLUONG_CFMWRAP_HSM_FUNCTIONS_H_
