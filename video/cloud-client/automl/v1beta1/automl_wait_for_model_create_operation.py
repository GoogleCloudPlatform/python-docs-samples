...
# sample-metadata
#   title: Wait for model creation to complete
#   description: Wait for model creation to complete
#   usage: python3 samples/v1beta1/automl_wait_for_model_create_operation.py [--project "[Google Cloud Project ID]"] [--operation_id "[Operation ID]"]
import sys

# [START automl_wait_for_model_create_operation]
...
def sample_wait_for_model_create_operation(project, operation_id, timeout):
    """
    ...
    operation_return_type = model_pb2.Model
...
# [END automl_wait_for_model_create_operation]
...
def main():
    ...
    sample_wait_for_model_create_operation(
        args.project, args.operation_id, args.timeout
    )
