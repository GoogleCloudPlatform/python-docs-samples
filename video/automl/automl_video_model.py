...
def create_model(project_id, compute_region, dataset_id, model_name):
    """Create a model."""
    # [START automl_video_create_model]
    ...
    # [END automl_video_create_model]


def get_operation_status(operation_full_id):
    """Get operation status."""
    # [START automl_video_get_operation_status]
    # TODO(developer): Uncomment and set the following variables
    # operation_full_id =
    ...
    # [END automl_video_get_operation_status]


def list_models(project_id, compute_region, filter_):
    """List all models."""
    # [START automl_video_list_models]
    # TODO(developer): Uncomment and set the following variables
    # project_id = 'PROJECT_ID_HERE'
    # compute_region = 'COMPUTE_REGION_HERE'
    ...
    # [END automl_video_list_models]


def get_model(project_id, compute_region, model_id):
    """Get model details."""
    # [START automl_video_get_model]
    # TODO(developer): Uncomment and set the following variables
    # project_id = 'PROJECT_ID_HERE'
    # compute_region = 'COMPUTE_REGION_HERE'
...
def list_model_evaluations(project_id, compute_region, model_id, filter_=None):
    ...
    # [END automl_video_list_model_evaluations]
...
def get_model_evaluation(
    ...
    # [START automl_video_get_model_evaluation]
    # TODO(developer): Uncomment and set the following variables
    # project_id = 'PROJECT_ID_HERE'
    # compute_region = 'COMPUTE_REGION_HERE'
    # model_id = 'MODEL_ID_HERE'
    ...
    # [END automl_video_get_model_evaluation]



def delete_model(project_id, compute_region, model_id):
    """Delete a model."""
    # [START automl_video_delete_model]
    # TODO(developer): Uncomment and set the following variables
    # project_id = 'PROJECT_ID_HERE'
    # compute_region = 'COMPUTE_REGION_HERE'
    # model_id = 'MODEL_ID_HERE'
